...
class DetentoProxyTest {
    ...
    @BeforeEach
    void setUp(){
        BancoDados.addDetento(new Detento(1, "Julio", "25 anos", "Centro, Juiz de Fora", "3611047", "10745147878"));
    }

    @Test
    void deveRetornarDadosPublicosDetento(){
        DetentoProxy detento = new DetentoProxy(1);
        assertEquals(Arrays.asList("Julio", "25 anos"), detento.obterDadosPublicosDetento());
    }
